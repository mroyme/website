...
The advice is always the same: read the email, reply if needed, archive it. And every time I have the same thought: why?

Not because I'm against organising things. If anything, I'm probably too organised. My dotfiles are version controlled, I like clean abstractions, and I enjoy removing unnecessary complexity. Which is exactly why I don't archive my email.
...
Done. That's it. No folders. No archive. No decision about where it belongs. If I need it again, Gmail search will find it.
...
When I'm done with an email, I mark it as read. If I still need it, I star it. Otherwise I forget it exists. Not because it's gone, but because I know search will find it in two seconds.

Archiving feels like an extra step. For my workflow, archiving changes location but not behaviour. The email is still searchable. It's still part of the same conversation. It's still there when I need it. The only thing that changed is that it no longer has the Inbox label.
